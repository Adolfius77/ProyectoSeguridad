...
# Creación de widgets
lbl_titulo = tk.Label(ventana_registro, text="Registro de Usuario", font=("Verdana", 20, "bold"), bg="#afbfeb",
                      fg="#4C4FFF")
...
lbl_contrasena_confirmar = tk.Label(panel_central, text="Confirmar Contraseña:", font=("Verdana", 12, "bold"),
                                    bg="#ffffff")
lbl_contrasena_confirmar.pack(pady=15, padx=80)

entry_contrasena_confirmar = tk.Entry(panel_central, show="*", bg="#f0f0f0", bd=2, relief="sunken",
                                      font=("Verdana", 11))
entry_contrasena_confirmar.pack(pady=5, padx=80)

btn_registrar = tk.Button(panel_central, text="Registrar", command=validar_registro, font=("Verdana", 12), bg="#4C4FFF",
                          fg="#ffffff", bd=0, padx=10, pady=5)
